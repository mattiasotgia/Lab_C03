...
\begin{document}
    ...
    Ripetiamo questo procedimento per sette misure di massa differenti, e trascriviamo i valori in tabella. %% <<-------INDICARE TABELLA!!!!!
    ...
    inoltre un ampiezza maggiore porta ad avere una velocità maggiore e quindi, poiché l'attrito viscoso 
