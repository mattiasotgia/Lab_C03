...
\newcommand{\Tiso}{$T^*$}
\newcommand{\xiso}{$x^*$}
\newcommand{\LrVALUE}{$l_R=(0.800010\pm0.000010)$~mm}
...
\begin{document}
    ...
    Abbiamo già accennato alla maggiore accuratezza nell'utilizzare il pendolo di Kater per misurare con maggiore precisione il valore di $g$. Infatti il pendolo di Kater può essere posto nella condizione di isocronia, dove il periodo misurato con il pendolo in un verso, viene uguale al periodo del caso in cui il pendolo sia fatto oscillare per l'altro estremo di oscillazione.
