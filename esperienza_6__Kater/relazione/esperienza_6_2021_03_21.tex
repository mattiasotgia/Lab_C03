...
\begin{document}
    ...
    \begin{@twocolumnfalse}
        ...
        \begin{abstract}
            \textit{Obiettivo-- }
            Si vuole sfruttare uno strumento di precisione come il pendolo di Kater per ricavare dalla misura 
            accuraata del periodo di oscillazione un valore atendibile della misura dell'accelerazione di gravità 
            $g$.
            \textit{Metodi-- }
